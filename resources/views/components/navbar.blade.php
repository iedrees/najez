<div  x-data="{ isDialogOpen:false, openUserMenu:false, openProjectMenu:false }">
                ...
                <div class="sm:ml-6 sm:flex sm:items-center">
                    @auth
                        <div 
                            ...
                            <button @click="openProjectMenu = true" type="button"
                            ...
                            <div class="origin-top-left absolute left-0 w-56 ">
                                <div x-show="openProjectMenu" @click.away="openProjectMenu = false" class="rounded-b-md bg-gray-100 p-1 -ml-0.5"
                                    role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
 

                                    <div class="py-1 mt-px bg-white rounded-sm">

                                        <a href="#" @click.prevent="isDialogOpen = true"
