            ...
            <div class="">
                <div class="">
                    <nav class="flex -mb-px">
                        <a href="{{route('projects.show', $project->id)}}" class="@if(request()->route()->getName() == 'projects.show')  border-gray-600 font-bold text-gray-600   @endif  text-gray-500 hover:text-gray-700 border-transparent border-b-2 group inline-flex items-center py-4 px-1  font-medium text-sm leading-5 focus:outline-none">
                            <svg class="ml-2 h-5 w-5 text-gray-500 group-hover:text-gray-700" fill="currentColor" viewBox="0 0 20 20"><path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"></path><path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm9.707 5.707a1 1 0 00-1.414-1.414L9 12.586l-1.293-1.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                            <span> المهام </span>
                        </a>
                        <a href="{{route('projects.settings', $project->id)}}" class="@if(request()->route()->getName() == 'projects.settings')  border-b-2 border-gray-600 font-bold text-gray-600   @endif  text-gray-500 mx-px px-4 group inline-flex items-center py-4 px-1 border-b-2 border-transparent font-medium text-sm leading-5    focus:outline-none  ">
                            <svg class="ml-2 h-5 w-5 text-gray-500 group-hover:text-gray-700" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd"></path></svg>
                            <span> الإعدادات </span>
                        </a>
                    </nav>
                </div>
