<div>
    <div class="mb-3 flex rounded-sm shadow-sm">
        ...
        <textarea id="task" 
            ...
            class="p-3 block w-full rounded-none rounded-r-md transition ease-in-out duration-150 text-gray-500 border border-white focus:border-indigo-400  focus:outline-none" 
            placeholder="أنشئ تاسك جديدة .. " >
        </textarea>
        </div>
        <button wire:click="submit" class="relative inline-flex items-center px-4 py-2 border-gray-300 text-sm leading-5 font-medium rounded-l-md text-gray-700 bg-indigo-400 hover:text-gray-500 hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500 focus:shadow-outline-blue focus:border-white active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
