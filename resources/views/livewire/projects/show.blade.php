<div>
    ...
    <div class="bg-white shadow-sm overflow-hidden sm:rounded-lg border-t border-gray-100 ">

        <div class=" container mx-auto">
            <div class="block focus:outline-none focus:bg-gray-50 transition duration-150 ease-in-out">
                <div class="flex items-center">
                    <div class="flex-shrink-0 py-5 p-2">
    ...
    <div class="border-t-2 border-{{data_get($project, 'color', 'teal')}}-200 bg-white">
        <div class="container mx-auto">
            <div class="">
            <div class="">
                <nav class="flex -mb-px">
                <a href="#" class="group inline-flex items-center py-4 px-1 border-b-2 border-transparent font-medium text-sm leading-5 text-gray-700 border-b-2 border-gray-700 font-bold focus:outline-none">
                    <svg class="ml-2 h-5 w-5 text-gray-700 group-hover:text-gray-500 group-focus:text-gray-600" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"/>
                    </svg>
                    <span> المهام </span>
                </a>
                <a href="#" class="mx-px px-4 group inline-flex items-center py-4 px-1 border-b-2 border-transparent font-medium text-sm leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300">
                    <svg class="ml-2 h-5 w-5 text-gray-400 group-hover:text-gray-500 group-focus:text-gray-600" viewBox="0 0 20 20" fill="currentColor">
