<main id="submit"
    ...
    <section class="flex flex-wrap p-4">
        ...
        <button type="button" @click='isDialogOpen = true' wire:click="submit">add new
            project
        </button>
        ...
        <div class="overflow-auto" style="background-color: rgba(0,0,0,0.5)"
            ...
            <div
                ...
                <div class="p-2">
                    ...
                    <button wire:click="submit" @click="isDialogOpen = false"  >✖</button> </div>
                    <div class="mb-3 flex rounded shadow-sm bg-gray-200 p-1">
                        <div class="relative flex-grow focus-within:z-10">
                            <textarea id="name"
                                      ...
                                      placeholder="أنشئ مشروع جديد . ">
                            </textarea>
                            </div>
                        </div>
                    <div class="flex justify-between items-center border-b p-2 text-xl">{{--                        <button type="button" @click="isDialogOpen = false">✖</button>--}}
                        <button @click="isDialogOpen = false" wire:click="submit"
                                ...
                                px-4 py-2 border-gray-300 text-sm leading-5 font-medium rounded-l  bg-indigo-400 hover:text-gray-500 hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500 focus:shadow-outline-blue focus:border-white active:bg-gray-100 active:text-gray-700  ">حفظ المشروع
                        </button>
                    </div>
                </div>
