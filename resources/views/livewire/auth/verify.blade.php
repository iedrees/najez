        ...
        <div class="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
            @if (session('resent'))
                <div class="flex items-center px-4 py-3 mb-6 text-sm text-white bg-green-500 rounded shadow" role="alert">
                    ...
                    <p>رابط التحقق تم إرساله إلي بريدك الإلكتروني</p>
                </div>
            @endif

            <div class="text-sm text-gray-700">
                <p>الرجاء التاكد من بريدك الإلكتروني و رابط التحقق المرسل </p>

                <p class="mt-3">
                     ،اذا لم تحصل علي البريد الإلكتروني <a wire:click="resend" class="text-indigo-700 cursor-pointer hover:text-indigo-600 focus:outline-none focus:underline transition ease-in-out duration-150">click here to request another</a>.
                </p>
            </div>
        </div>
    </div>
