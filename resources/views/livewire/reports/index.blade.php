            ...
            <table class="min-w-full">
              ...
              <tbody>
                ...
                <tr class="bg-white @if (!$loop->last) border-b-2 @endif  border-gray-100">
                  ...
                  <td class="px-6 w-32 py-4 bg-{{$task->project->color}}-50 border-{{$task->project->color}}-100 @if (!$loop->last) border-b-2 @endif font-bold whitespace-no-wrap text-base leading-5 text-gray-500">
                    {{$task->project->name}}
                  </td>
                  <td class="px-6 w-56  max-w-md py-4 whitespace-no-wrap text-sm leading-5 font-medium text-gray-900">
