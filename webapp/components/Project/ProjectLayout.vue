            ...
            <div class="block focus:outline-none focus:bg-gray-50 transition duration-150 ease-in-out">
                <div class="flex items-center">
                    ...
                    <div class="min-w-0 px-5 py-5 flex-1 sm:flex sm:items-center sm:justify-between ">
                        <div>
                            <div class="font-medium text-cool-gray-800 truncate">
                            ...
                            <div class="mt-3 flex">
                                <div class="flex overflow-hidden">
                                    ...
                                    <router-link  v-if="item.id && item.amILeader" :to="{name:'projectTeam', params: {id:item.id}}" class="inline-flex items-center p-px px-1.5 mx-2 rounded bg-gray-100 text-cool-gray-700 bg-white hover:bg-gray-200 focus:outline-none transition ease-in-out duration-150">
                                        <svg class="h-5 w-5 text-cool-gray-500"  fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clip-rule="evenodd"></path></svg>
                                    </router-link>
                                </div>
                            </div>
                        </div>
    ...
    <div class="border-t shadow-sm border-gray-100 border-dottedx bg-white">
        <div class="container mx-auto pt-1">
                <nav class="flex -mb-px" >
                    <router-link v-if="item.id" :to="{name:'projectIndex', params: {id:item.id}}" exact active-class="border-indigo-800 font-bold text-indigo-800" class="-mb-px text-cool-gray-400 hover:text-indigo-700 border-transparent border-b-2 group inline-flex items-center py-4 px-1  font-medium text-sm leading-5 focus:outline-none">
                    ...
                    <router-link v-if="item.id" :to="{name:'projectTeam', params: {id:item.id}}" exact active-class="border-indigo-800 font-bold text-indigo-800" class="hover:text-indigo-800 -mb-px text-cool-gray-400 mx-px px-4 group inline-flex items-center py-4 px-1 border-b-2 border-transparent font-medium text-sm leading-5    focus:outline-none  ">
                        <svg class="ml-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20"><path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"></path></svg>
                        <span> الفريق </span>
                    </router-link>
