    ...
    <div class="border-t shadow-sm border-gray-100 border-dottedx bg-white">
        <div class="container mx-auto pt-1">
                <nav class="flex -mb-px" >
                    <router-link v-if="item.id" :to="{name:'projectIndex', params: {id:item.id}}" exact active-class="border-indigo-800 font-bold text-indigo-800" class="-mb-px text-gray-400 hover:text-indigo-700 border-transparent border-b-2 group inline-flex items-center py-4 px-1  font-medium text-sm leading-5 focus:outline-none">
                    ...
                    <router-link v-if="item.id" :to="{name:'projectSettings', params: {id:item.id}}" exact  active-class="border-indigo-800 font-bold text-indigo-800" class="hover:text-indigo-800 -mb-px text-gray-400 mx-px px-4 group inline-flex items-center py-4 px-1 border-b-2 border-transparent font-medium text-sm leading-5    focus:outline-none  ">
