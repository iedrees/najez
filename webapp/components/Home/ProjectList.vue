<template>
  <div>
      ...
      <div v-for="project in items" :key="project.id" class="bg-white hover:bg-teal-50 shadow-smx overflow-hidden sm:rounded-sm mb-2 p-px">
            <router-link :to="{name:'projectIndex', params: {id:project.id}}"
                ...
                <div class="flex items-center">
                    <div
                        class="flex-shrink-0 py-5 rounded-r-sm  p-2 bg-gray-50  border-l-2  border-teal-100">
