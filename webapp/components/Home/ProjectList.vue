                    ...
                    <div class="min-w-0 px-5 py-5 flex-1 sm:flex sm:items-center sm:justify-between ">
                        <div>
                            <div class="font-medium text-cool-gray-600 truncate">
                                <b class="text-2xl"> {{project.name}} 
                                <!-- <span class="text-xs ms-2 text-cool-gray-300 inline-block">{{parseFloat(((project.done_tasks_count * 100) / project.tasks_count).toFixed(0))}}%</span> -->
                                </b>
                            </div>
